...
// ======== EASY ========
  localparam E_ROW_COLUMN_NUMBER = 6; 
  localparam E_MINE_NUM          = 7;
...
// ======== MEDIUM ========
  localparam M_ROW_COLUMN_NUMBER = 8; 
  localparam M_MINE_NUM          = 16;
  localparam M_TIMER_SECONDS     = 70;
...
// ======== HARD ========
  localparam H_ROW_COLUMN_NUMBER = 12; 
  localparam H_MINE_NUM          = 30;
  localparam H_TIMER_SECONDS     = 90;
